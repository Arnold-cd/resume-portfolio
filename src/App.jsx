...
Sent from your portfolio website`
  ...
  const SplashScreen = () => (
    <div className="h-screen bg-gray-900 flex items-center px-12">
      <div className="max-w-7xl mx-auto grid grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6">
          <h1 className="text-6xl font-bold text-white">Arnold</h1>
          <p className="text-xl text-gray-400">Developer</p>
          <button
            onClick={() => setCurrentView('main')}
            className="px-8 py-3 bg-blue-500 rounded-full hover:bg-blue-600 transition-colors flex items-center space-x-2"
          >
            <span>Click Me</span>
            <span>→</span>
          </button>
  ...
  const ContactForm = () => (
    <div className="min-h-screen bg-black p-8">
      <button
        onClick={() => setCurrentView('main')}
        className="mb-8 px-4 py-2 rounded-full border border-white text-white hover:bg-white hover:text-black transition-colors"
      >
        ← Back
      </button>
    ...
    <div className="min-h-screen bg-black text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center space-x-6">
            <button
              ...
              className="px-6 py-2 rounded-full border border-white hover:bg-white hover:text-black transition-colors"
            >
              Contact Me
            </button>
            <a
      ...
      <div className="pt-24">
        {sections.map((section) => (
          <div
            key={section.id}
            className="relative w-full h-[70vh] transition-all duration-700 ease-in-out"
            style={{
              height: activeSection === section.id ? '85vh' : '70vh',
            }}
          ...
          >
            ...
            <div className="relative z-20 h-full max-w-7xl mx-auto px-6 flex items-center">
              <div className="max-w-2xl">
                <h2
                  className="text-5xl font-bold mb-6 transform transition-all duration-700"
                  style={{
                ...
                <p
                  className="text-xl transform transition-all duration-700 delay-100 whitespace-pre-line"
                  style={{
                    transform: activeSection === section.id ? 'translateY(0)' : 'translateY(20px)',
                    opacity: activeSection === section.id ? 1 : 0,
                  }}
